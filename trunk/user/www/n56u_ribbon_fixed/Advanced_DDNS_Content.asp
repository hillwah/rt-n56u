                                        ...
                                        <tr id="row_ddns_checkip" style="display:none;">
                                            ...
                                            <td>
                                                <select name="ddns_checkip" class="input" onchange="disable_update();">
                                                    ...
                                                    <option value="1" <% nvram_match_x("", "ddns_checkip", "1","selected"); %>>ddns.oray.com</option>
                                                    <option value="2" <% nvram_match_x("", "ddns_checkip", "2","selected"); %>>checkip.dyndns.org</option>
